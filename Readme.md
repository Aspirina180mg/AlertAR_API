...
Esta API fue diseñada para ser usada y modificada por el Equipo de DataRockers para el proyecto AlertAR, más endpoints serán agregados según necesidad del proyecto y pueden ser consultados en la sección de docs de la API, en 
...
4. 1. Para probar la api debes ingresar a tu [localhost, se recomienda ingresar a la sección de docs (127.0.0.1:8000/docs)](127.0.0.1:8000/docs)
5. Hacer deploy en Render, si posees o te creas una cuenta en [Render](https://render.com/), puedes hacer tu propio deploy de la API.Los ajustes usados para hacer el deploy son los siguientes
